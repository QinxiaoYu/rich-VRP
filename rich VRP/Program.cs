    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10000; i++)
            {
                ...
                //ReadInitialSolution initial = new ReadInitialSolution(@"C:\Users\user\Desktop\Good Solution\reslut265249.csv");
                ...
                Console.WriteLine(cost.ToString("0.00") + ": Route Numbers = " + ini_solution.Routes.Count.ToString() + "Veh Number = " + ini_solution.fleet.VehFleet.Count.ToString());
                ...
                BreakTwoRoute br = new BreakTwoRoute();
                ini_solution = br.Break(ini_solution, 4);
                VehTypeChangeIntra VTC = new VehTypeChangeIntra();
                ini_solution = VTC.ChangeToLVehWithLessCharge(ini_solution);
                cost = ini_solution.CalObjCost();
                Console.WriteLine("ObjVal 0 = " + cost.ToString("0.00"));
                Console.WriteLine(cost.ToString("0.00") + ": Route Numbers = " + ini_solution.Routes.Count.ToString() + "Veh Number = " + ini_solution.fleet.VehFleet.Count.ToString());
                sb.AppendLine(cost.ToString("0.00") + ": Route Numbers = " + ini_solution.Routes.Count.ToString() + "Veh Number = " + ini_solution.fleet.VehFleet.Count.ToString());

                localSearch.stop_criteria = 1000;
                localSearch.perturb_criteria = 10;
                localSearch.restart_criteria = 15;
                ini_solution = localSearch.search(ini_solution, sb, true);
