...
//    {
//        /// <summary>
//        /// 在路径中最优位置插入电站，若插入后有不满足的cus，将该cus扔回pool中
//        /// </summary>
//        /// <param name="route"></param>
//        /// <param name="deleted_cus"></param>
//        /// <returns></returns>
//        public Route InsertStaInRoute(Route route,out List<Customer> deleted_cus)
//        {
//            Route bst_route = null;
//            List<Customer> delete_cus = new List<Customer>();
//            if (route.IsFeasible())
//            {
//                bst_route = route;
//            }
...
//                    else
//                    {
//                        int violate_node_seat = route.ViolationOfRange();     
//                        AbsNode violate_node = route.RouteList[violate_node_seat - 1];
//                        if (violate_node.Info.Type == 2)
//                        {
//                            route.RemoveAt(violate_node_seat - 1);//从该路径中删掉
//                            delete_cus.Add((Customer)violate_node);
//                        }
//                        if (route.IsFeasible())
//                        {
//                            feasible = true;
...
//        public Solution InsertCusToSolution(Solution solution,List<Customer> Cus_Pool)
//        {
